...
"""
path_local = "."
#path_local = "/home/emanuel/Documentos/Project/python/mia/misArchivos"
    ...
    for archivo in file_list:
        if archivo == 'mia_main.py' or archivo == 'bottle.py' or archivo == 'bottle.pyc':
            ...
            if os.path.isdir(file_path) == True:
                to_html = to_html + u"<tr><td><i class='icon folder'></i><a href='%s/%s'>%s </a></td> <td class='data'>%s</td> <td class='data'>%s</td> </tr>" % (request.fullpath, archivo, archivo, date_file(file_path), convert_bytes(file_path))
            else:
                ...
                if extension in TEXT_TYPE:
                    ...
                    type_file = 'unknow'
                to_html = to_html + u"<tr><td><i class='icon %s'></i><a href='/download?file=%s/%s'>%s</a></td> <td class='data'>%s</td> <td class='data'>%s</td> </tr>" % (type_file, path, archivo, archivo, date_file(file_path), convert_bytes(file_path))
    return HEADER + to_html + FOOTER	
